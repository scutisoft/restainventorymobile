  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = Container(
      ...
      //  spacing: 8,
        children: <Widget>[
          TextButton(
            child: Text("Cancel",style: TextStyle(fontSize: 16,fontFamily: datePickerFontFamily,color: ColorUtil.themeBlack),),
            onPressed: _handleCancel,
          ),
          TextButton(
            child: Text("Ok",style: TextStyle(fontSize: 16,fontFamily: datePickerFontFamily,color: ColorUtil.themeBlack),),
            onPressed: _handleOk,
          ),
        ],
      ),
...
///
///
String datePickerFontFamily="AR";
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Text title = Text(
      ...
      //SELECTED DATE STYLE
      style: TextStyle(fontFamily: datePickerFontFamily,fontSize: 18,color: colorScheme.onPrimary),

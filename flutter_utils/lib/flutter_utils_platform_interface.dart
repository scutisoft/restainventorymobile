...
abstract class FlutterUtilsPlatform extends PlatformInterface {
  ...
  Future<List> getInvoke(List<ParamModel> parameterList,{String url="/api/Mobile/GetInvoke", RxBool? loader}){throw UnimplementedError('getInvoke() has not been implemented.');}

  Future<List> getInvokeLazy(List<ParamModel> parameterList,{String url="/api/Mobile/GetInvoke"}){throw UnimplementedError('getInvoke() has not been implemented.');}

  Future<List<ParamModel>> getFrmCol(var widgets){throw UnimplementedError('getFrmCollection has not been implemented.'); }

  void setFrmValuesV1(var widgets,List valueArray,{bool fromClearAll=false}){ throw UnimplementedError('setFrmValuesV1() has not been implemented.'); }
  ...
  void clearAllV4(widgets){ throw UnimplementedError('clearAllV4() has not been implemented.'); }
  ...
  void foundWidgetByKeyV1(var widgets,String key,{bool needSetValue=false,dynamic value}){ throw UnimplementedError('foundWidgetByKeyV1() has not been implemented.');}
